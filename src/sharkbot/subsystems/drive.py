...
class DriveSubsystem(commands2.Subsystem):
    def __init__(self) -> None:
        ...
        front_left_location = wpimath.geometry.Translation2d(DriveConstants.TRACK_HALF_WIDTH,
                                                             DriveConstants.WHEELBASE_HALF_LENGTH)
        front_right_location = wpimath.geometry.Translation2d(DriveConstants.TRACK_HALF_WIDTH,
                                                              -DriveConstants.WHEELBASE_HALF_LENGTH)
        back_left_location = wpimath.geometry.Translation2d(-DriveConstants.TRACK_HALF_WIDTH,
                                                            DriveConstants.WHEELBASE_HALF_LENGTH)
        back_right_location = wpimath.geometry.Translation2d(-DriveConstants.TRACK_HALF_WIDTH,
                                                             -DriveConstants.WHEELBASE_HALF_LENGTH)
        ...
        self.x_controller = ProfiledPIDController(
            DriveConstants.PIDX_KP, 0, 0,
            TrapezoidProfile.Constraints(DriveConstants.HORIZ_MAX_V, DriveConstants.HORIZ_MAX_A)
        )
        self.x_controller.setTolerance(DriveConstants.HORIZ_POS_TOL, DriveConstants.HORIZ_VEL_TOL)

        # Controller for the y direction (+ left, viewed by the driver)
        self.y_controller = ProfiledPIDController(
            DriveConstants.PIDY_KP, 0, 0,
            TrapezoidProfile.Constraints(DriveConstants.HORIZ_MAX_V, DriveConstants.HORIZ_MAX_A)
        )
        self.y_controller.setTolerance(DriveConstants.HORIZ_POS_TOL, DriveConstants.HORIZ_VEL_TOL)
        ...
        self.rot_controller = ProfiledPIDController(
            DriveConstants.PID_ROT_KP, 0, 0,
            TrapezoidProfile.Constraints(DriveConstants.ROT_MAX_V, DriveConstants.ROT_MAX_A)
        )
        self.rot_controller.setTolerance(DriveConstants.ROT_POS_TOL, DriveConstants.ROT_VEL_TOL)
    ...
    def get_current_distances(self) -> wpimath.kinematics.MecanumDriveWheelPositions:
        ...
        rev_to_m = 1.414 * math.pi * DriveConstants.WHEEL_DIA / DriveConstants.GEAR_RATIO
    ...
    def get_current_speeds(self) -> wpimath.kinematics.MecanumDriveWheelSpeeds:
        ...
        rpm_to_m_s = 1.414 * math.pi * DriveConstants.WHEEL_DIA / DriveConstants.GEAR_RATIO / 60
